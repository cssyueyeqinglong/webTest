<%@page import="com.cy.test.utils.CookieUtils"%>
...
<body>
	...
	<div
		...
		<h4 style="float: left; font: 14px/30px"微软雅黑 ";">浏览记录&nbsp;&nbsp;&nbsp;&nbsp;</h4>
		<a style="float: left; font: 14px/30px"
			微软雅黑 ";" href="/cy_test/clearHistory">清空浏览记录</a>
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				...
				<%
						...
						String[] cookies = cook.getValue().split("-");
						for (int i = 0; i < cookies.length; i++) {
							String id = cookies[i];
				%>
				<li
					style="width: 150px; height: 216; float: left; margin: 0 8px 0 0; padding: 0 18px 15px; text-align: center;"><img
					src="products/1/cs1000<%=id%>.jpg" width="130px" height="130px" /></li>
				<%
					}
					}
				%>
